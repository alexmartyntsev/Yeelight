...
namespace YeelightNET
{
    public class Yeelight
    {
        ...
        private const int DevicePort = 1982; //Yeelight comm port
        ...
        public static async Task<List<Device>> DiscoverDevices(int pingTime = 20)
        {
            ...
            using (UdpClient socket = new UdpClient())
            {
                ...
                IPEndPoint remoteEndPoint = new IPEndPoint(multicastAddress, DevicePort);
                IPEndPoint anyEndPoint = new IPEndPoint(IPAddress.Any, DevicePort);
